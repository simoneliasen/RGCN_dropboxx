...
class IOptimizer:
    ...
    def theano_process_update_function(self, parameters, loss_function):
        return self.next_component.theano_process_update_function(
    ...
    def process_gradient_function(self, loss_function, parameters_to_optimize):
        return self.next_component.process_gradient_function(
            loss_function, parameters_to_optimize
        )

    def process_update_function(self, gradient_function, parameters_to_optimize):
        return self.next_component.process_update_function(
            gradient_function, parameters_to_optimize
        )
